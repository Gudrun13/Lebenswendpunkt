...
export default function Blog() {
  useSEO({
    title: "Blog – Gedanken & Impulse zu Trauer, Angst und Neuanfängen",
    description: "Artikel von Gudrun Murina zu Themen wie Trauer, Angst, Lebenskrisen und innerer Neuorientierung. Impulse für Menschen in Umbruchphasen.",
    canonical: "https://lebenswendepunkt.de/blog",
  });

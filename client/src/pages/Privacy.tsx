...
export default function Privacy() {
  useSEO({
    title: "Datenschutzerklärung – Lebenswendepunkt",
    description: "Datenschutzerklärung von Lebenswendepunkt, Gudrun Murina.",
    canonical: "https://lebenswendepunkt.de/datenschutz",
    noIndex: true,
  });

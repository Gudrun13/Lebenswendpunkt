...
export default function Workbooks() {
  useSEO({
    title: "Workbooks – Digitale Begleitbücher für Deine Lebenswendepunkte",
    description: "Praktische Workbooks und Selbsthilfe-Materialien von Gudrun Murina für Menschen in Umbruchphasen, Trauer und Lebenskrisen. Sofort als Download verfügbar.",
    canonical: "https://lebenswendepunkt.de/workbooks",
  });

...
export default function Revocation() {
  useSEO({
    title: "Widerrufsbelehrung – Lebenswendepunkt",
    description: "Widerrufsbelehrung für digitale Inhalte von Lebenswendepunkt, Gudrun Murina.",
    canonical: "https://lebenswendepunkt.de/widerruf",
    noIndex: true,
  });
